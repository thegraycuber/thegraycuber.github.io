...
imgs.push(new Icon([windowWidth/2-px*2.4,min(windowHeight-px*2,windowHeight/2+px*8)],px*1.2,0,'https://www.youtube.com/@TheGrayCuber','_blank'));
	imgs.push(new Icon([windowWidth/2+px*2.4,min(windowHeight-px*2,windowHeight/2+px*8)],px*1.2,1,'https://github.com/thegraycuber','_blank'));
	update_imgs();
	...
	var links;
	if (prod){
		imgs.push(new Icon([windowWidth/2,min(windowHeight-px*2,windowHeight/2+px*8)],px*1.5,2,'https://thegraycuber.github.io/about.html','_self'));
		...
		imgs.push(new Icon([windowWidth/2,min(windowHeight-px*2,windowHeight/2+px*8)],px*0.5,2,'https://openprocessing.org/sketch/2499975','_self'));
